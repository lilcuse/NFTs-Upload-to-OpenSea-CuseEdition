...
root.title("NFTs Upload to OpenSea Cuse Edition  ")
...
button_cuse = tkinter.Button(root, width=20, bg="blue", fg="white", text="Twitter @nftcuse", command=open_browser)
button_cuse.grid(row=28, column=1)
button_cuse = tkinter.Button(root, width=20, bg="blue", fg="white", text="Discord Cuse#8245", command=open_browser)
button_cuse.grid(row=30, column=1)
try:
    with open(save_file_path(), "rb") as infile:
        new_dict = pickle.load(infile)
        global upload_path
